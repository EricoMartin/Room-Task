...
import com.basebox.betterwayapp.databinding.ActivityFriendsBinding
import com.basebox.betterwayapp.databinding.ActivityMainBinding
...
class FriendsActivity : AppCompatActivity() {
    ...
    private fun setUpData(binding: ActivityFriendsBinding) {
        binding.recyclerViewFriends.adapter = adapter
        binding.recyclerViewFriends.addItemDecoration(DividerItemDecoration(this, LinearLayout.VERTICAL))
